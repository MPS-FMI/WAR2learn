...
namespace licenta
{
    public partial class Admin : System.Web.UI.MasterPage
    {
        ...
        {
            Response.Redirect("Actualizeaza.aspx?cuv=" + TextBoxSearchCuv.Text + "&categ=" + CategoriiDropDown.SelectedValue.ToString() + "&pmin=" + DropDownListPret1.SelectedValue.ToString() + "&pmax=" + DropDownListPret2.SelectedValue.ToString());
        }
